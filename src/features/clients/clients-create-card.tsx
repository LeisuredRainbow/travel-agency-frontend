...
import type { ClientRequest } from '#/lib/travel/schemas'

interface Props {
  value: ClientRequest
  onChange: React.Dispatch<React.SetStateAction<ClientRequest>>
  onApply: () => void
  isPending: boolean
...
export function ClientsCreateCard({ value, onChange, onApply, isPending, editingId, onCancelEdit }: Props) {
